...
const MODAL_CSS = `
  ...
  .add-modal-input {
    ...
    border-radius: 12px; color: #fff; font-size: 15px; padding: 13px 16px;
    width: 100%; outline: none;
    transition: border-color 0.15s ease, background 0.15s ease, box-shadow 0.15s ease;
    box-sizing: border-box; font-family: inherit;
  }
  .add-modal-input::placeholder { color: rgba(255,255,255,0.3); }
  .add-modal-input:focus { border-color: rgba(99,179,255,0.6); background: rgba(255,255,255,0.09); box-shadow: 0 0 0 3px rgba(99,179,255,0.15); }
  .add-modal-btn-primary {
    ...
    font-size: 15px; font-weight: 600; padding: 13px 0; cursor: pointer; flex: 1;
    transition: filter 0.15s ease, transform 0.12s ease; font-family: inherit; letter-spacing: 0.01em;
  }
  ...
  .add-modal-btn-cancel {
    ...
    border-radius: 12px; color: rgba(255,255,255,0.6); font-size: 15px; font-weight: 500;
    padding: 13px 0; cursor: pointer; flex: 0 0 100px;
    transition: background 0.15s ease, color 0.15s ease, transform 0.12s ease; font-family: inherit;
  }
  ...
  .icon-zone {
    ...
    border: 1.5px dashed rgba(255,255,255,0.18); background: rgba(255,255,255,0.04);
    display: flex; flex-direction: column; align-items: center; justify-content: center; gap: 7px;
    cursor: pointer; transition: border-color 0.18s ease, background 0.18s ease, transform 0.15s ease;
    position: relative; overflow: hidden; box-sizing: border-box;
  }
  .icon-zone:hover, .icon-zone:focus-visible { border-color: rgba(99,179,255,0.5); background: rgba(99,179,255,0.06); outline: none; }
  .icon-zone.drag-over { border-color: rgba(99,179,255,0.8); background: rgba(99,179,255,0.1); transform: scale(1.01); }
  .icon-zone.filled { border-style: solid; border-color: rgba(255,255,255,0.1); }
    ...
    <>
      ...
      <div
        ...
        style={{
          ...
          borderRadius: "24px",
          boxShadow:
            "0 24px 64px rgba(0,0,0,0.6), inset 0 1px 0 rgba(255,255,255,0.18)",
          padding: "32px",
          display: "flex",
